...
Input:
  NN_open_code/data/fig5a_source_public.csv

Output:
  NN_open_code/outputs/figures/Fig5a_PANSS_positive_vs_ripple_counts.pdf
...
def main():
    ...
    out_pdf = root / "outputs" / "figures" / "Fig5a_PANSS_positive_vs_ripple_counts.pdf"
    ...
    if miss:
        raise ValueError(f"fig5a_source_public.csv missing columns: {sorted(miss)}")
