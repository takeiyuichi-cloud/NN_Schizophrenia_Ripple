...
Outputs (<root>/outputs/tables/):
  - Supplementary_Table_S8_total_ripple_load_vs_clinical.xlsx
  - Table_S8_total_ripple_load_vs_clinical.Table_S8_total_ripple_load_vs_clinical.csv
"""
...
def main():
    ...
    out_csv=out_dir/"Table_S8_total_ripple_load_vs_clinical.csv"
    out.to_csv(out_csv, index=False)

    try:
        tpl=_find_template(root, "supp_table10.xlsx")
        out_xlsx=out_dir/"Supplementary_Table_S8_total_ripple_load_vs_clinical.xlsx"
